...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_CREATE :
          hInstance = (HINSTANCE) GetWindowLong (hwnd, GWL_HINSTANCE) ;
               ...
               // Create the black-rectangle window against which the 
          ...
          hBrushStatic = CreateSolidBrush (RGB(0,0,255));
     ...
     case WM_CTLCOLORSTATIC :
          ...
          {
               SelectObject((HDC) wParam, RGB(0,0,0));
               SetTextColor ((HDC) wParam, crPrim[i % 3]) ;
               //SetBkColor ((HDC) wParam, GetSysColor (COLOR_BTNHIGHLIGHT));
               SetBkColor ((HDC) wParam, RGB(0,0,0));  //Make text background color black
     ...
     case WM_SYSCOLORCHANGE :
          ...
          hBrushStatic = CreateSolidBrush (RGB(255,0,0)) ;
          return 0 ;
