...
#include <windows.h>
#define LIGHTORANGE RGB(250,200,150)
     ...
     case WM_PAINT:
          ...
          TextOut (hdc, 0, 0, szBuffer, 
               wsprintf (szBuffer, TEXT (" %s: Face Name = %s, CharSet = %i"),
                         ...
                         szFaceName, tm.tmCharSet)) ;                           // Character set identifier

          SetTextAlign (hdc, TA_TOP | TA_CENTER) ;

               // vertical and horizontal lines

          SelectObject (hdc, CreatePen(PS_SOLID, 0, LIGHTORANGE));
          for (i = 0 ; i < 17 ; i++)
          {
