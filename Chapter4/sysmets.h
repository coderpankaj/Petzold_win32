...
sysmetrics[] =
{
    ...
    SM_CXMAXIMIZED,     TEXT("SM_CXMAXIMIZED"),     TEXT("WIDTH OF THE MAXIMIZED WINDOW"),
    SM_CYMAXIMIZED,     TEXT("SM_CYMAXIMZED"),      TEXT("HEIGHT OF THE MAXIMIZED WINDOW"),
    SM_NETWORK,         TEXT("SM_NETWORK"),         TEXT("NETWORK PRESENT FLAG"),
    SM_CLEANBOOT,       TEXT("SM_CLEANBOOT"),       TEXT("HOW SYSTEM BOOTED"),
    ...
    SM_MIDEASTENABLED,  TEXT("SM_MISEASTENABLED"),  TEXT("HEBREW AND ARABIC ENABLED FLAG"),
    SM_MOUSEWHEELPRESENT,TEXT("SM_MOUSEWHEELPRESENT"),TEXT("MOUSE WHEEL PRESENT FLAG"),
    SM_XVIRTUALSCREEN,  TEXT("SM_XVIRUTALSCREEN"),  TEXT("VIRTUAL SCREEN X ORIGIN"),
