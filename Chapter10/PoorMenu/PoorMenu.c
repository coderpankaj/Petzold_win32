                    ...
                    PSTR szCmdLine, int iCmdShow)
{
     ...
     {
          MessageBox (NULL, TEXT ("This program requires Windows NT! and above"),
     ...
     /* GetSystemMenu : Enables the application to access the window menu for copying and modifying */
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
     ...
     case WM_SYSCOMMAND:
          ...
          case IDM_SYS_REMOVE:
              // Reverts the system menu to default state
